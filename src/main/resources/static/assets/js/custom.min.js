function init_sidebar() {
    ...
    $SIDEBAR_MENU.find("a").on("click", function(b) {
        ...
        $SIDEBAR_MENU.find("li ul").slideUp()), c.addClass("active"), $("ul:first", c).slideDown(function() {
            a();
        }));
    }), $MENU_TOGGLE.on("click", function() {
        $BODY.hasClass("nav-md") ? ($SIDEBAR_MENU.find("li.active ul").hide(), $SIDEBAR_MENU.find("li.active").addClass("active-sm").removeClass("active")) : ($SIDEBAR_MENU.find("li.active-sm ul").show(), 
...
function countChecked() {
    ...
    a ? ($(".column-title").hide(), $(".bulk-actions").show(), $(".action-cnt").html(a + " Records Selected")) : ($(".column-title").show(), 
    $(".bulk-actions").hide());
}
...
function init_flot_chart() {
    if ("undefined" != typeof $.plot) {
        ...
        for (var a = [ [ gd(2012, 1, 1), 17 ], [ gd(2012, 1, 2), 74 ], [ gd(2012, 1, 3), 6 ], [ gd(2012, 1, 4), 39 ], [ gd(2012, 1, 5), 20 ], [ gd(2012, 1, 6), 85 ], [ gd(2012, 1, 7), 7 ] ], b = [ [ gd(2012, 1, 1), 82 ], [ gd(2012, 1, 2), 23 ], [ gd(2012, 1, 3), 66 ], [ gd(2012, 1, 4), 9 ], [ gd(2012, 1, 5), 119 ], [ gd(2012, 1, 6), 6 ], [ gd(2012, 1, 7), 9 ] ], c = [], d = [ [ 0, 1 ], [ 1, 9 ], [ 2, 6 ], [ 3, 10 ], [ 4, 5 ], [ 5, 17 ], [ 6, 6 ], [ 7, 10 ], [ 8, 7 ], [ 9, 11 ], [ 10, 35 ], [ 11, 9 ], [ 12, 12 ], [ 13, 5 ], [ 14, 3 ], [ 15, 4 ], [ 16, 9 ] ], e = 0; e < 30; e++) c.push([ new Date(Date.today().add(e).days()).getTime(), randNum() + e + e + 10 ]);
        var f = {
            series: {
                lines: {
                    show: !1,
        ...
        $("#chart_plot_01").length && (console.log("Plot1"), $.plot($("#chart_plot_01"), [ a, b ], f)), 
        ...
        } ], g)), $("#chart_plot_03").length && (console.log("Plot3"), $.plot($("#chart_plot_03"), [ {
            label: "Registrations",
            data: d,
            lines: {
                fillColor: "rgba(150, 202, 89, 0.12)"
...
function init_starrr() {
    "undefined" != typeof starrr && (console.log("init_starrr"), $(".stars").starrr(), 
...
function init_gauge() {
    if ("undefined" != typeof Gauge) {
        ...
        if ($("#gauge-text").length && (c.maxValue = 6e3, c.animationSpeed = 32, c.set(3200), 
        c.setTextField(document.getElementById("gauge-text"))), $("#chart_gauge_02").length) var d = document.getElementById("chart_gauge_02"), e = new Gauge(d).setOptions(a);
        $("#gauge-text2").length && (e.maxValue = 9e3, e.animationSpeed = 32, e.set(2400), 
...
function init_cropper() {
    if ("undefined" != typeof $.fn.cropper) {
        ...
        var a = $("#image"), b = $("#download"), c = $("#dataX"), d = $("#dataY"), e = $("#dataHeight"), f = $("#dataWidth"), g = $("#dataRotate"), h = $("#dataScaleX"), i = $("#dataScaleY"), j = {
            ...
            preview: ".img-preview",
            crop: function(a) {
                c.val(Math.round(a.x)), d.val(Math.round(a.y)), e.val(Math.round(a.height)), f.val(Math.round(a.width)), 
                g.val(a.rotate), h.val(a.scaleX), i.val(a.scaleY);
            }
        };
        ...
        }).cropper(j), $.isFunction(document.createElement("canvas").getContext) || $('button[data-method="getCroppedCanvas"]').prop("disabled", !0), 
        "undefined" == typeof document.createElement("cropper").style.transition && ($('button[data-method="rotate"]').prop("disabled", !0), 
        $('button[data-method="scale"]').prop("disabled", !0)), "undefined" == typeof b[0].download && b.addClass("disabled"), 
        $(".docs-toggles").on("change", "input", function() {
            var b, c, d = $(this), e = d.attr("name"), f = d.prop("type");
            a.data("cropper") && ("checkbox" === f ? (j[e] = d.prop("checked"), b = a.cropper("getCropBoxData"), 
            c = a.cropper("getCanvasData"), j.built = function() {
                a.cropper("setCropBoxData", b), a.cropper("setCanvasData", c);
            }) : "radio" === f && (j[e] = d.val()), a.cropper("destroy").cropper(j));
        }), $(".docs-buttons").on("click", "[data-method]", function() {
            var a, c, d = $(this), e = d.data();
            if (!d.prop("disabled") && !d.hasClass("disabled") && f.data("cropper") && e.method) {
                if (e = $.extend({}, e), "undefined" != typeof e.target && (a = $(e.target), "undefined" == typeof e.option)) try {
                    e.option = JSON.parse(a.val());
                } catch (f) {
                    console.log(f.message);
                }
                switch (c = f.cropper(e.method, e.option, e.secondOption), e.method) {
                  case "scaleX":
                  case "scaleY":
                  ...
                  case "getCroppedCanvas":
                    c && ($("#getCroppedCanvasModal").modal().find(".modal-body").html(c), b.hasClass("disabled") || b.attr("href", c.toDataURL()));
                }
                if ($.isPlainObject(c) && a) try {
                    a.val(JSON.stringify(c));
                } catch (f) {
                    console.log(f.message);
                }
            }
        ...
        var k, l = $("#inputImage"), m = window.URL || window.webkitURL;
        m ? l.change(function() {
            var b, c = this.files;
            a.data("cropper") && c && c.length && (b = c[0], /^image\/\w+$/.test(b.type) ? (k = m.createObjectURL(b), 
            a.one("built.cropper", function() {
                m.revokeObjectURL(k);
            }).cropper("reset").cropper("replace", k), l.val("")) : window.alert("Please choose an image file."));
        }) : l.prop("disabled", !0).parent().addClass("disabled");
    }
}
...
function init_knob() {
    if ("undefined" != typeof $.fn.knob) {
        console.log("init_knob"), $(".knob").knob({
            ...
            draw: function() {
                if ("tron" == this.$.data("skin")) {
                    this.cursorExt = .3;
                    var a, b = this.arc(this.cv), c = 1;
                    return this.g.lineWidth = this.lineWidth, this.o.displayPrevious && (a = this.arc(this.v), 
                    this.g.beginPath(), this.g.strokeStyle = this.pColor, this.g.arc(this.xy, this.xy, this.radius - this.lineWidth, a.s, a.e, a.d), 
                    this.g.stroke()), this.g.beginPath(), this.g.strokeStyle = c ? this.o.fgColor : this.fgColor, 
                    this.g.arc(this.xy, this.xy, this.radius - this.lineWidth, b.s, b.e, b.d), this.g.stroke(), 
        ...
        $("input.infinite").knob({
            ...
            stopper: !1,
            change: function() {
                a > this.cv ? b ? (h(), b = 0) : (b = 1, c = 0) : a < this.cv && (c ? (g(), c = 0) : (c = 1, 
                b = 0)), a = this.cv;
            }
        });
    }
...
function init_ColorPicker() {
    "undefined" != typeof $.fn.colorpicker && (console.log("init_ColorPicker"), $(".demo1").colorpicker(), 
    $(".demo2").colorpicker(), $("#demo_forceformat").colorpicker({
        format: "rgba",
        horizontal: !0
...
function init_daterangepicker() {
    if ("undefined" != typeof $.fn.daterangepicker) {
        ...
        $("#reportrange").daterangepicker(b, a), $("#reportrange").on("show.daterangepicker", function() {
...
function init_daterangepicker_right() {
    if ("undefined" != typeof $.fn.daterangepicker) {
        ...
        $("#reportrange_right").daterangepicker(b, a), $("#reportrange_right").on("show.daterangepicker", function() {
            console.log("show event fired");
...
function init_SmartWizard() {
    ...
    }), $(".buttonNext").addClass("btn btn-success"), $(".buttonPrevious").addClass("btn btn-primary"), 
    $(".buttonFinish").addClass("btn btn-default"));
}

function init_validator() {
    "undefined" != typeof validator && (console.log("init_validator"), validator.message.date = "not a real date", 
...
function init_CustomNotification() {
    if (console.log("run_customtabs"), "undefined" != typeof CustomTabs) {
        ...
        TabbedNotification = function(b) {
            ...
            $("#custom_notifications #notif-group").append(c), a++, CustomTabs(b)) : alert("doesnt exists");
        }, CustomTabs = function(a) {
            $(".tabbed_notifications > div").hide(), $(".tabbed_notifications > div:first-of-type").show(), 
            $("#custom_notifications").removeClass("dsp_none"), $(".notifications a").click(function(a) {
                a.preventDefault();
        ...
        $(document).on("click", ".notification_close", function(a) {
            idname = $(this).parent().parent().attr("id"), b = idname.substr(-2), $("#ntf" + b).remove(), 
            $("#ntlink" + b).parent().remove(), $(".notifications a").first().addClass("active"), 
...
function init_EasyPieChart() {
    if ("undefined" != typeof $.fn.easyPieChart) {
        ...
        $.fn.popover.Constructor.prototype.leave = function(a) {
            var c, d, e = a instanceof this.constructor ? a : $(a.currentTarget)[this.type](this.getDelegateOptions()).data("bs." + this.type);
            b.call(this, a), a.currentTarget && (c = $(a.currentTarget).siblings(".popover"), 
            d = e.timeout, c.one("mouseenter", function() {
...
function init_charts() {
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        ...
        if ($("#lineChart").length) {
            var a = document.getElementById("lineChart");
            new Chart(a, {
                type: "line",
                data: {
                    labels: [ "January", "February", "March", "April", "May", "June", "July" ],
        ...
        if ($("#mybarChart").length) {
            var a = document.getElementById("mybarChart");
            new Chart(a, {
                type: "bar",
                data: {
                    labels: [ "January", "February", "March", "April", "May", "June", "July" ],
        ...
        if ($("#canvasDoughnut").length) {
            var a = document.getElementById("canvasDoughnut"), b = {
        ...
        if ($("#canvasRadar").length) {
            var a = document.getElementById("canvasRadar"), b = {
        ...
        if ($("#pieChart").length) {
            var a = document.getElementById("pieChart"), b = {
                datasets: [ {
                    data: [ 120, 50, 140, 180, 100 ],
                    backgroundColor: [ "#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB" ],
                    label: "My dataset"
        ...
        if ($("#polarArea").length) {
            var a = document.getElementById("polarArea"), b = {
                datasets: [ {
                    data: [ 120, 50, 140, 180, 100 ],
                    backgroundColor: [ "#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB" ],
                    label: "My dataset"
...
function init_calendar() {
    if ("undefined" != typeof $.fn.fullCalendar) {
        ...
        var a, b, c = new Date(), d = c.getDate(), e = c.getMonth(), f = c.getFullYear(), g = $("#calendar").fullCalendar({
            header: {
            ...
            selectable: !0,
            selectHelper: !0,
            select: function(c, d, e) {
                $("#fc_create").click(), a = c, ended = d, $(".antosubmit").on("click", function() {
                    var c = $("#title").val();
                    return d && (ended = d), b = $("#event_type").val(), c && g.fullCalendar("renderEvent", {
                        title: c,
                        start: a,
                        end: d,
                        allDay: e
                    }, !0), $("#title").val(""), g.fullCalendar("unselect"), $(".antoclose").click(), 
                    !1;
                });
            },
            eventClick: function(a, c, d) {
                $("#fc_edit").click(), $("#title2").val(a.title), b = $("#event_type").val(), $(".antosubmit2").on("click", function() {
            ...
            events: [ {
                title: "All Day Event",
                start: new Date(f, e, 1)
            }, {
                title: "Long Event",
                start: new Date(f, e, d - 5),
                end: new Date(f, e, d - 2)
            }, {
                title: "Meeting",
                start: new Date(f, e, d, 10, 30),
                allDay: !1
            }, {
                title: "Lunch",
                start: new Date(f, e, d + 14, 12, 0),
                end: new Date(f, e, d, 14, 0),
                allDay: !1
            }, {
                title: "Birthday Party",
                start: new Date(f, e, d + 1, 19, 0),
                end: new Date(f, e, d + 1, 22, 30),
                allDay: !1
            }, {
                title: "Click for Google",
                start: new Date(f, e, 28),
                end: new Date(f, e, 29),
                url: "http://google.com/"
            } ]
        });
...
$.fn.popover.Constructor.prototype.leave = function(a) {
    var b, c, d = a instanceof this.constructor ? a : $(a.currentTarget)[this.type](this.getDelegateOptions()).data("bs." + this.type);
    originalLeave.call(this, a), a.currentTarget && (b = $(a.currentTarget).siblings(".popover"), 
    c = d.timeout, b.one("mouseenter", function() {
        clearTimeout(c), b.one("mouseleave", function() {
            $.fn.popover.Constructor.prototype.leave.call(d, d);
        });
    }));
}, $("body").popover({
    selector: "[data-popover]",
    ...
    init_JQVmap(), init_cropper(), init_knob(), init_IonRangeSlider(), init_ColorPicker(), 
    init_TagsInput(), init_parsley(), init_daterangepicker(), init_daterangepicker_right(), 
    init_daterangepicker_single_call(), init_daterangepicker_reservation(), init_SmartWizard(), 
    init_EasyPieChart(), init_charts(), init_echarts(), init_morris_charts(), init_skycons(), 
    init_select2(), init_validator(), init_DataTables(), init_chart_doughnut(), init_gauge(), 
    init_PNotify(), init_starrr(), init_calendar(), init_compose(), init_CustomNotification(), 
    init_autosize(), init_autocomplete();
});